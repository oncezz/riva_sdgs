      ...
      <div v-show="menuSelectedId == 1">
        <div class="row">
          ...
          <div class="col q-px-md">
            <div class="q-pt-md">
              <div class="font-24">
                How did your group's integration with this group progress across
                years?
              </div>
            </div>
            <div v-if="ecoIntegrationChart.length >= 4">
              Since {{ input.year.min }}, {{ yourGroupName.toLowerCase() }}'s
              integration with this group
            ...
            <div v-else>
              Since {{ input.year.min }}, {{ yourGroupName }}'s integration with
              this group
              {{ ecoIntegrationPercentChange > 0 ? "increased" : "decreased" }}
              by
      ...
      <div v-show="menuSelectedId == 2">
        <div class="row">
          ...
          <div class="col q-px-md">
            <div class="q-pt-md">
              <div class="font-24">
                How did your group's integration with this group progrtess
                across periods?
              </div>
...
export default {
  ...
  methods: {
    ...
    menu2Subtitle() {
      ...
      } else if (this.menu2RawData.length >= 3) {
        this.menu2SubtitleSentence2 =
          this.menu2SentenceHigh[0].name +
          " (" +
          Number(this.menu2SentenceHigh[0].diff).toFixed(2) +
